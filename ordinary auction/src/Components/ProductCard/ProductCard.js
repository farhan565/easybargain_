...
export default class ProductCard extends React.Component {
    ...
    render() {
        ...
        return (<div className="ProductCard">
            ...
            <BidTimer timeFromServer={1440} sendData={this.handleDataChange} />
    ...
    async  bidProduct() {
        ...
        await axios.get("http://localhost:4002/product/view/" + this.props.title).then((data) => {
        ...
        if (!(this.state.price == "") && !(this.props.username == "")) {
            ...
            if (tempArray.length <= 0 || this.state.price > HighestBid
                ...
                await axios.post("http://localhost:4002/product/updateproduct", { prodName: this.props.title, bidhistory: tempArray }).then((data) => {
